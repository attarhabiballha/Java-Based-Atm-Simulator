...
public class Withdrawl extends JFrame implements ActionListener{
    ...
    String pin,email;
     CDate wd=new CDate();
    Withdrawl(String pin,String email){
        this.pin = pin;
        this.email=email;
     ...
     /*   l1.setBounds(190,350,400,20);
        ...
        l2.setBounds(400,250,700,35);
        l3.add(l2);
        
        t1.setBounds(400,290,330,30);
        l3.add(t1);
        
        b1.setBounds(635,385,150,35);
        l3.add(b1);
        
        b2.setBounds(635,460,150,35);
        l3.add(b2);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        //___________________________________________________________________________
                     String msg="Dear Customer : Your A/C is debited through ATM by "+amount+" Total Bal:Rs."+balance+"\n "+wd.cdateTimeFun();
             SmsSender.sendEmail(msg,"Amount Debited \n" , email);
